const Card = ({index, stat}) => {
    return(
      ...
      >
            {/* Icon: top-right */}
            <div
              className="position-absolute d-flex justify-content-center align-items-center cardStyle"
              style={{
                top: '12px',
                right: '12px',
                width: '40px',
              ...
              {stat.breakdown && (
                <div className="pt-3 border-top small text-muted">
                  {stat?.breakdown.map((i) => (
                    <div key={i.title} className="d-flex justify-content-between">
                      <span>{i.title}</span>
